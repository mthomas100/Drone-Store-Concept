...
export type MarketingCardGroupBy = {
  ...
  descriptionDarkness?: Maybe<Array<Maybe<MarketingCardConnectionDescriptionDarkness>>>;
};
...
export type Morph = UsersPermissionsMe | UsersPermissionsMeRole | UsersPermissionsLoginPayload | UserPermissionsPasswordPayload | Hero | UpdateHeroPayload | DeleteHeroPayload | MarketingCard | MarketingCardConnection | MarketingCardAggregator | MarketingCardGroupBy | MarketingCardConnectionId | MarketingCardConnection_Id | MarketingCardConnectionCreatedAt | MarketingCardConnectionUpdatedAt | MarketingCardConnectionHeader | MarketingCardConnectionDescription | MarketingCardConnectionImage | MarketingCardConnectionHeaderDarkness | MarketingCardConnectionDescriptionDarkness | CreateMarketingCardPayload | UpdateMarketingCardPayload | DeleteMarketingCardPayload | Product | ProductConnection | ProductAggregator | ProductGroupBy | ProductConnectionId | ProductConnection_Id | ProductConnectionCreatedAt | ProductConnectionUpdatedAt | ProductConnectionName | ProductConnectionDescription | ProductConnectionImage | ProductConnectionSlug | CreateProductPayload | UpdateProductPayload | DeleteProductPayload | SellingPoint | UpdateSellingPointPayload | DeleteSellingPointPayload | Testimonial | TestimonialConnection | TestimonialAggregator | TestimonialGroupBy | TestimonialConnectionId | TestimonialConnection_Id | TestimonialConnectionCreatedAt | TestimonialConnectionUpdatedAt | TestimonialConnectionName | TestimonialConnectionTitle | TestimonialConnectionImage | TestimonialConnectionTestimonial | CreateTestimonialPayload | UpdateTestimonialPayload | DeleteTestimonialPayload | I18NLocale | UploadFile | UploadFileConnection | UploadFileAggregator | UploadFileAggregatorSum | UploadFileAggregatorAvg | UploadFileAggregatorMin | UploadFileAggregatorMax | UploadFileGroupBy | UploadFileConnectionId | UploadFileConnection_Id | UploadFileConnectionCreatedAt | UploadFileConnectionUpdatedAt | UploadFileConnectionName | UploadFileConnectionAlternativeText | UploadFileConnectionCaption | UploadFileConnectionWidth | UploadFileConnectionHeight | UploadFileConnectionFormats | UploadFileConnectionHash | UploadFileConnectionExt | UploadFileConnectionMime | UploadFileConnectionSize | UploadFileConnectionUrl | UploadFileConnectionPreviewUrl | UploadFileConnectionProvider | UploadFileConnectionProvider_Metadata | DeleteFilePayload | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsRoleConnection | UsersPermissionsRoleAggregator | UsersPermissionsRoleGroupBy | UsersPermissionsRoleConnectionId | UsersPermissionsRoleConnection_Id | UsersPermissionsRoleConnectionName | UsersPermissionsRoleConnectionDescription | UsersPermissionsRoleConnectionType | CreateRolePayload | UpdateRolePayload | DeleteRolePayload | UsersPermissionsUser | UsersPermissionsUserConnection | UsersPermissionsUserAggregator | UsersPermissionsUserGroupBy | UsersPermissionsUserConnectionId | UsersPermissionsUserConnection_Id | UsersPermissionsUserConnectionCreatedAt | UsersPermissionsUserConnectionUpdatedAt | UsersPermissionsUserConnectionUsername | UsersPermissionsUserConnectionEmail | UsersPermissionsUserConnectionProvider | UsersPermissionsUserConnectionConfirmed | UsersPermissionsUserConnectionBlocked | UsersPermissionsUserConnectionRole | CreateUserPayload | UpdateUserPayload | DeleteUserPayload | ComponentComponentsSpecification | ComponentComponentsTextDarkness;
...
export type FragmentImageFragment = (
  { __typename?: 'UploadFile' }
  & Pick<UploadFile, 'id' | 'createdAt' | 'updatedAt' | 'name' | 'alternativeText' | 'caption' | 'width' | 'height' | 'formats' | 'hash' | 'ext' | 'mime' | 'size' | 'url'>
);
...
export type Marketing_Cards_QueryQuery = (
  ...
  & { marketingCards?: Maybe<Array<Maybe<(
    { __typename: 'MarketingCard' }
    & Pick<MarketingCard, 'id' | '_id' | 'createdAt' | 'updatedAt' | 'header' | 'description'>
...
export type Products_QueryQuery = (
  ...
  & { products?: Maybe<Array<Maybe<(
    { __typename: 'Product' }
    & Pick<Product, 'id' | '_id' | 'createdAt' | 'updatedAt' | 'name' | 'description' | 'slug'>
    & { image?: Maybe<(
      { __typename?: 'UploadFile' }
      & FragmentImageFragment
    )> }
...
export type Selling_Point_QueryQuery = (
  ...
  & { sellingPoint?: Maybe<(
    { __typename: 'SellingPoint' }
    & Pick<SellingPoint, 'id' | '_id' | 'createdAt' | 'updatedAt' | 'header' | 'description'>
    & { specifications?: Maybe<Array<Maybe<(
      { __typename: 'ComponentComponentsSpecification' }
      & Pick<ComponentComponentsSpecification, 'id' | '_id' | 'spec' | 'description'>
    )>>> }
  )> }
);
...
export type Testimonials_QueryQuery = (
  ...
  & { testimonials?: Maybe<Array<Maybe<(
    { __typename: 'Testimonial' }
    & Pick<Testimonial, 'id' | '_id' | 'createdAt' | 'updatedAt' | 'name' | 'title' | 'testimonial'>
    & { image?: Maybe<(
      { __typename?: 'UploadFile' }
      & FragmentImageFragment
    )> }
 ...
 * });
 */
export function useHero_QueryQuery(baseOptions?: Apollo.QueryHookOptions<Hero_QueryQuery, Hero_QueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Hero_QueryQuery, Hero_QueryQueryVariables>(Hero_QueryDocument, options);
      }
export function useHero_QueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Hero_QueryQuery, Hero_QueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Hero_QueryQuery, Hero_QueryQueryVariables>(Hero_QueryDocument, options);
        }
export type Hero_QueryQueryHookResult = ReturnType<typeof useHero_QueryQuery>;
export type Hero_QueryLazyQueryHookResult = ReturnType<typeof useHero_QueryLazyQuery>;
export type Hero_QueryQueryResult = Apollo.QueryResult<Hero_QueryQuery, Hero_QueryQueryVariables>;